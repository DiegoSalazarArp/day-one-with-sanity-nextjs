...
/* GROQ busca un documento de tipo "event" cuyo slug.current
 coincide con $slug. Devuelve el primer resultado, 
 incluyendo todos los campos del documento y expandiendo 
 las referencias a headline y venue. */
